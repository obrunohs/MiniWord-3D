...
VERSÃO v12 - AJUSTES ONLINE
- Duplo clique em outro jogador abre menu transparente com Perfil e Trade.
- Trade permite escolher mobis do inventário e exige confirmação dos dois jogadores.
- Mobis só podem ser colocados/movidos/recolhidos pelo dono do quarto.
- Velocidade de movimento agora usa tempo real para ficar parecida no PC e celular.
- Celular: use dois dedos para aproximar/afastar o zoom e rotacionar a câmera.
