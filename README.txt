MiniWorld 3D Habbo - Firebase Online
...
O Firebase do projeto miniworld-3d já foi integrado no script.js.

O que foi adicionado:
- Login com e-mail e senha usando Firebase Auth.
- Tela separada de cadastro com nome do jogador, e-mail e senha.
...
Observação:
O jogo agora precisa ser aberto via servidor ou GitHub Pages. Se abrir direto clicando no index.html, alguns navegadores podem bloquear módulos JavaScript.
