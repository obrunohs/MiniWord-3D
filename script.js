...
function setupAvatarEditor() {
  ...
  btn.onclick = () => {
    ...
    document.getElementById('avatarSkin').value = c.skin || '#f2b879';
    document.getElementById('avatarHair').value = c.hair || '#4b2e1f';
    document.getElementById('avatarShirt').value = c.shirt || '#2563eb';
    document.getElementById('avatarPants').value = c.pants || '#1e3a8a';
    if (document.getElementById('avatarShoes')) document.getElementById('avatarShoes').value = c.shoes || '#111827';
    if (document.getElementById('avatarHairStyle')) document.getElementById('avatarHairStyle').value = c.hairStyle || 'curto';
    if (document.getElementById('avatarEyeStyle')) document.getElementById('avatarEyeStyle').value = c.eyeStyle || 'normal';
    if (document.getElementById('avatarMouthStyle')) document.getElementById('avatarMouthStyle').value = c.mouthStyle || 'sorriso';
    modal.classList.remove('hidden');
  };
  ...
  document.getElementById('saveAvatarBtn').onclick = async () => {
    ...
    c.skin = document.getElementById('avatarSkin').value;
    c.hair = document.getElementById('avatarHair').value;
    c.shirt = document.getElementById('avatarShirt').value;
    c.pants = document.getElementById('avatarPants').value;
    c.shoes = document.getElementById('avatarShoes')?.value || c.shoes || '#111827';
    c.hairStyle = document.getElementById('avatarHairStyle')?.value || c.hairStyle || 'curto';
    c.eyeStyle = document.getElementById('avatarEyeStyle')?.value || c.eyeStyle || 'normal';
    c.mouthStyle = document.getElementById('avatarMouthStyle')?.value || c.mouthStyle || 'sorriso';

    if (currentUser.uid) {
      await setDoc(doc(db, 'users', currentUser.uid), {
        profile: { ...(currentUser.profile || {}), character: c, characterId: c.id },
        updatedAt: serverTimestamp()
