...
if(!btn) return;
btn.onclick=()=>document.getElementById('avatarModal').classList.remove('hidden');
document.getElementById('closeAvatarBtn').onclick=()=>document.getElementById('avatarModal').classList.add('hidden');
document.getElementById('saveAvatarBtn').onclick=()=>{
 ...
 alert('Avatar salvo. Reentre no quarto para atualizar.');
};
}

setTimeout(()=>{try{setupAvatarEditor();}catch(e){}},1500);
