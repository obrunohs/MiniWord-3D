...
export const mobiCatalog = [
  ...
  // Raros
  { id: 'raro_dino_esqueleto', name: 'Esqueleto de Dinossauro', icon: '🦖', desc: 'Raro grande: esqueleto alto de dinossauro.', price: 2500, color: 0xf5e6b2, category: 'raros', variant: 'dino_skeleton', rarity: 'raro' }
];
