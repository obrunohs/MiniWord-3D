...
export const roomShapes = [
  ...
  { id: 'comprido', name: 'Comprido', desc: 'Sala profunda', squares: 187, w: 11, d: 17, css: 'shape-long', preview: 'long', sections: [{x:0,z:0,w:11,d:17}] },
  ...
  { id: 'corredor', name: 'Corredor', desc: 'Quarto estreito e comprido', squares: 126, w: 7, d: 18, css: 'shape-corridor', preview: 'corridor', sections: [{x:0,z:0,w:7,d:18}] },
  { id: 'formato_l', name: 'Formato L', desc: 'Duas áreas em L', squares: 168, w: 16, d: 16, css: 'shape-l', preview: 'l', sections: [{x:-3,z:0,w:10,d:16}, {x:3,z:4,w:10,d:8}] },
  { id: 'formato_t', name: 'Formato T', desc: 'Área larga com corredor central', squares: 172, w: 16, d: 16, css: 'shape-t', preview: 't', sections: [{x:0,z:-4,w:16,d:8}, {x:0,z:4,w:7,d:8}] },
  { id: 'formato_u', name: 'Formato U', desc: 'Duas alas com centro aberto', squares: 204, w: 18, d: 16, css: 'shape-u', preview: 'u', sections: [{x:-5,z:0,w:8,d:16}, {x:5,z:0,w:8,d:16}, {x:0,z:-5,w:18,d:6}] },
  { id: 'dividido', name: 'Dividido', desc: 'Dois ambientes conectados', squares: 208, w: 18, d: 14, css: 'shape-divided', preview: 'divided', sections: [{x:-4,z:0,w:10,d:14}, {x:5,z:0,w:8,d:10}] }
];
